...
const primaryQuestions = [
  ...
  "Kể tên 3 bài hát mà bạn tự tin có thể karaoke cháy hết mình.",
  "Kể tên 2 món ăn mà bạn thích nhất.",
  "Ba đặc điểm tính cách ở người khác được bạn đánh giá cao?",
  "Bây giờ mà có tiền thì bạn sẽ đi du lịch ở đâu?",
  ...
  "Nếu được ước một điều thì bạn sẽ dành điều ước đó cho ai?",
  "Ước mơ lúc nhỏ của bạn là gì?",
  "Bạn yêu thích ngón tay nào nhất?",
